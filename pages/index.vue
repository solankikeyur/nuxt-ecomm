  ...
  <FrontLayout>
    <section class="bg-white dark:bg-gray-900">
      ...
      >
        ...
        >
         App built using Nuxt3
        </h1>
        <p
          class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400"
        >
          A simple login, register, cart, checkout app. For storage used Supabase and for payment used Stripe Card checkout. State management tool used is Pinia.
        </p>
        <div
          class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4"
        >
          <a
            href="https://github.com/solankikeyur/nuxt-ecomm.git"
            target="_blank"
